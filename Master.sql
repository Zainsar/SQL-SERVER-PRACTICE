...
--DDL TRIGEERS FOR CRAETE TABLE ON DATABASE
CREATE TRIGGER TR_CREATE ON DATABASE
FOR CREATE_TABLE
AS
BEGIN
PRINT 'Q HATH LAGA RAHY HO'
END
...
--DDL TRIGGERS FOR CRAETE DATABASE ON SERVER
CREATE TRIGGER TR_CREATEDB ON ALL SERVER
FOR CREATE_DATABASE
AS
BEGIN
...
CREATE DATABASE ZAIN
CREATE TABLE ZAINS (ID INT)
DROP TABLE ZAINS
ALTER TABLE HR_Emp ADD ZAIN VARCHAR(255)
